...
ALTER TABLE E_SCHEMA.ENTHAELT DROP CONSTRAINT ENTHAELT.PKEY;
ALTER TABLE E_SCHEMA.ENTHAELT ADD C_ID INT;
ALTER TABLE E_SCHEMA.ENTHAELTADD PRIMARY KEY (C_ID);
