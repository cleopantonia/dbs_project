...
# Lade Datensatz in die Datenbank election in die Realtion twitter über die erstellte connection:
...
# erstelle neues data frame für enthaelt-table (e_schema) => Zieltabelle
...
# die Daten aus df_contains können nicht in die Datenbank in die Relation enthaelt importiert werden, da im Tweet mit der ID
# 4969 zweimal der Hashtag #Trump vorkommt
# Löschen des zweiten Eintrags der Doppelung würde alle anderen tables verfälschen (z.B. abs_hauf in e_schema.hashtag)
